...
public class Robot extends TimedRobot {
  ...
  public void robotPeriodic() {
    SmartDashboard.putNumber("Left Encoder value", m_Left.getSelectedSensorPosition());
    SmartDashboard.putNumber("Right Encoder value", m_Right.getSelectedSensorPosition());
